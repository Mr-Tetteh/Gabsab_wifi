<div class="min-h-screen w-full">
    <section class="relative overflow-hidden  w-full bg-gradient-to-b from-indigo-600 via-blue-500 to-transparent">
        <div class="w-full px-4 md:px-8">
            ...
            <div class="relative z-10 flex flex-col items-center justify-center min-h-[80vh]">
                ...
                <div class="text-center space-y-8">
                    <div class="mb-2">
                        <img src="{{asset('images/ChatGPT Image Jun 16, 2025, 11_17_44 PM.png')}}" class="mx-auto w-96 h-96 object-cover rounded-full" alt=""/>
                    </div>
                </div>
                ...
                <div class="text-center space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
                        <div class="bg-white/10 backdrop-blur-md rounded-xl p-6 hover:transform hover:scale-105 transition-all duration-300">
                            <svg class="w-12 h-12 text-black mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                            </svg>
                            <h3 class="text-xl font-bold  mb-2 text-black">High-Speed Internet</h3>
                            <p class="text-black/80 text-black">Lightning-fast connectivity for all your needs</p>
                        </div>
                        <div class="bg-white/10 backdrop-blur-md rounded-xl p-6 hover:transform hover:scale-105 transition-all duration-300">
                            <svg class="w-12 h-12 text-black mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                            </svg>
                            <h3 class="text-xl font-bold text-black mb-2">Secure Connection</h3>
                            <p class="text-black/80">Advanced security protocols to protect your data</p>
                        </div>
                        <div class="bg-white/10 backdrop-blur-md rounded-xl p-6 hover:transform hover:scale-105 transition-all duration-300">
                            <svg class="w-12 h-12 text-black mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                            </svg>
                            <h3 class="text-xl font-bold text-black mb-2">24/7 Support</h3>
                            <p class="text-black/80">Round-the-clock customer service</p>
                        </div>
                    </div>
                </div>
            </div>
