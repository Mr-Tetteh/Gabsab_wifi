            ...
            <div class="space-y-8">
                <div class="flex flex-col items-center md:items-start">
                    <a href="#" class="group relative">
                        <span class="text-3xl font-black tracking-wider bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">Gabsab</span>
                    ...
                    <div class="mt-6 space-y-3 text-gray-300 text-center md:text-left">
                        ...
                        <p class="flex items-center justify-center md:justify-start gap-2">
                            ...
                            <a href="mailto:gabasf@gmail.com" class="hover:text-blue-400 transition-all duration-300">gabas@gmail.com</a>
                        </p>
                    </div>
                </div>
            ...
            <div class="text-center md:text-left">
                ...
                <ul class="space-y-4">
                    <li class="transform transition-transform duration-300 hover:-translate-y-1">
                        <a href="{{route('home')}}" class="group flex items-center justify-center md:justify-start gap-2 text-gray-300 hover:text-blue-400 transition-colors">
                    ...
                    <li class="transform transition-transform duration-300 hover:-translate-y-1">
                        <a href="{{route('login')}}" class="group flex items-center justify-center md:justify-start gap-2 text-gray-300 hover:text-blue-400 transition-colors">
                            <span class="w-5 h-0.5 bg-blue-400 transform transition-transform duration-300 group-hover:w-6"></span>
                            Login
                        </a>
                    </li>
                    <li class="transform transition-transform duration-300 hover:-translate-y-1">
                        <a href="{{route('register')}}" class="group flex items-center justify-center md:justify-start gap-2 text-gray-300 hover:text-blue-400 transition-colors">
                            <span class="w-5 h-0.5 bg-blue-400 transform transition-transform duration-300 group-hover:w-6"></span>
                            Register
                        </a>
                    </li>
